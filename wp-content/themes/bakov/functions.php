...
function bakov_setup() {
	load_theme_textdomain( 'bakov', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
      ...
      'menu' => 'Меню каталог',
      'menu_boobs' => 'Пластика груди',
      'menu_face' => 'Пластика лица',
      'menu_body' => 'Пластика тела',
	 ) );
	...
	add_theme_support( 'custom-background', apply_filters( 'bakov_custom_background_args', array(
...
add_action( 'after_setup_theme', 'bakov_setup' );
...
function bakov_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'bakov_content_width', 640 );
}
add_action( 'after_setup_theme', 'bakov_content_width', 0 );

function bakov_widgets_init() {
...
add_action( 'widgets_init', 'bakov_widgets_init' );


function bakov_style() {
  ...
  wp_enqueue_style( 'vendor', get_template_directory_uri() . '/css/vendors.min.css');
  wp_enqueue_style( 'bakov-style', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'bakov_style' );

function bakov_scripts(){
  wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js',  array ('jquery'), '', true );
  wp_enqueue_script( 'flipster', get_template_directory_uri() . '/js/jquery.flipster.js',  array ('jquery'), '', true );
  wp_enqueue_script( 'inputmask', get_template_directory_uri() . '/js/jquery.inputmask.bundle.min.js',  array ('jquery'), '', true );
...
add_action( 'wp_enqueue_scripts', 'bakov_scripts' );
...
function dimox_breadcrumbs() {
  ...
  $sep = '<i class="fa fa-angle-right" aria-hidden="true"></i>'; // разделитель между "крошками"
