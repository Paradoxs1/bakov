<div class="sidebar">
    <div class="form-container clearfix">
       <div class="form-title"><h3><?php echo get_post_meta($post->ID, 'title_form', true); ?></h3></div>
       <div class="salesforce-form"><?php echo do_shortcode(get_post_meta($post->ID, 'text_form', true)); ?></div>
    </div>
    
    <?php if(!(is_page_template('page-patients.php'))){ ?>
